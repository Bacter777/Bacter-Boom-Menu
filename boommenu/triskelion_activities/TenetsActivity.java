package com.bacter.boommenu.triskelion_activities;
...
public class TenetsActivity extends AppCompatActivity
{
    ...
    {
        final TextView tenets_title = findViewById(R.id.tenets_title);
        ObjectAnimator anim = ObjectAnimator.ofInt(tenets_title,"textColor",
